...
public: 
    ...
    //    AddGossipItemFor(player,GOSSIP_ICON_DOT, "|TInterface/ICONS/Inv_misc_note_02:20|t Получить Звание [VIP]", GOSSIP_SENDER_MAIN, 9500);
        ...
        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface/icons/INV_Hammer_24:20|t Починить экипировку", GOSSIP_SENDER_MAIN, 6);
        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface/ICONS/Inv_misc_coin_17:20|t Продавец ->", GOSSIP_SENDER_MAIN, 10);
	...
	//	AddGossipItemFor(player,GOSSIP_ICON_DOT, "|TInterface/ICONS/Ability_mount_hordepvpmount:20|t Прото ездовые животные ->", GOSSIP_SENDER_MAIN, 1218);
        ...
        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface/ICONS/Inv_misc_book_07:20|t Баффы", GOSSIP_SENDER_MAIN, 1206);
        ...
        AddGossipItemFor(player, GOSSIP_ICON_DOT, "|TInterface/ICONS/Achievement_reputation_argentchampion:20|t Сбросить таланты", GOSSIP_SENDER_MAIN, 1207, "Таланты буду сброшены. Вы уверены?", 0, false);
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 uiSender, uint32 action)
	{
        ...
        case 11:
            ...
            case CLASS_PALADIN:
                ...
                player->learnSpell(201);	// Plate Mail
                player->learnSpell(200);	// PoleArms
                player->learnSpell(197);	// 2H Axe
                player->learnSpell(202);	// 2H Mace
                break;

            case CLASS_SHAMAN:
                CloseGossipMenuFor(player);
                player->learnSpell(15590);	// Fists
                player->learnSpell(1180);	// Mail
                player->learnSpell(196);	// Axes
                break;
            ...
            case CLASS_WARRIOR:
                ...
                player->learnSpell(1180);	// Dual Wield
                player->learnSpell(15590);	// Fists
                player->learnSpell(266);	// Guns
                player->learnSpell(198);	// Plate Mail
                player->learnSpell(200);	// PoleArms
                player->learnSpell(227);	// 2H Mace
                player->learnSpell(2567);	// Staves
            ...
            case CLASS_HUNTER:
                CloseGossipMenuFor(player);
                player->learnSpell(5011);	// Dual Wield
                player->learnSpell(1180);	// Fists
                player->learnSpell(15590);	// Guns
                player->learnSpell(266);	// Mail
                player->learnSpell(201);	// PoleArms
                player->learnSpell(200);	// Staves
                player->learnSpell(227);	// 2H Sword
        ...
        case 6: // Repair Items
            ...
            creature->Whisper("Предметы успешно отремонтированы!", LANG_UNIVERSAL, player);
		...
		case 1206: // Buffs
            ...
            else
            {
                ...
                creature->Whisper("Больше баффов откроется на 55-м уровне.", LANG_UNIVERSAL, player);
            }
			break;
		...
		case 2000: // Rename
			player->PlayerTalkClass->ClearMenus();
			AddGossipItemFor(player,GOSSIP_ICON_DOT, "|TInterface/ICONS/Trade_engineering:25|tИзменить внешность", GOSSIP_SENDER_MAIN, 2001);
